There is an issue with common words in the dictionary after 813 common words are generated (uncommon words are appended in alphabetical order), use caution when generating larger dictionaries.
