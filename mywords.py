...
class TextToSpeechConverter:
    def __init__(self, root):
        ...
        self.missing_words_label = ttk.Label(root, text="Missing Words:")
        self.missing_words_label.grid(row=6, column=0, pady=5)

        self.missing_words_listbox = tk.Listbox(root, selectmode="single", exportselection=0)
        self.missing_words_listbox.grid(row=7, column=0, pady=5)
    ...
    def convert_to_speech(self):
        ...
        # Update missing words listbox
        self.missing_words_listbox.delete(0, tk.END)
        for missing_word in missing_words:
            self.missing_words_listbox.insert(tk.END, missing_word)
